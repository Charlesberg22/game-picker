      ...
      {links.map((link) => {
        return (
          <Link
            ...
            href={link.href}
            className={clsx(
              "flex h-[36px] grow items-center rounded-md bg-black-50 text-sm font-medium hover:bg-emerald-100 hover:text-green-600 md:flex-none md:justify-start md:p-2 md:px-3",
              {
